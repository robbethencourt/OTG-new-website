<?php
$to = 'Service@office2Go.com'; // Put in your email address here
$subject  = "Web Contact Us"; // The default subject. Will appear by default in all messages. Change this if you want.
